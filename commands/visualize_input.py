...
def parse_args():
    ...
    parser.add_argument('min', type=int, nargs='?', default=vals.DEFAULT_SPACE_RANGE_MIN, help='A required positional integer'
                                                                                         ' - minimal value of axes '
                                                                                         'range')
    parser.add_argument('max', type=int, nargs='?', default=vals.DEFAULT_SPACE_RANGE_MAX, help='An optional positional '
                                                                                         'integer - maximal value of '
                                                                                         'axes range')
    parser.add_argument('step', type=float, nargs='?', default=vals.DEFAULT_SPACE_STEP, help='An optional positional float - '
                                                                                       'step of axes')
